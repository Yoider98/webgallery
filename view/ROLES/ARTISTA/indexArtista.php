                    ...
                    <div class="menu">
                        <ul class="navbar-nav ">
                            <li class="nav-item active">
                                <a class="nav-link boton" href="index.php">&nbsp&nbsp&nbsp&nbspInicio&nbsp&nbsp&nbsp&nbsp&nbsp</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link boton " href="#C">&nbspContactanos&nbsp</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link boton " href="artista.php">&nbspMis obras&nbsp</a>
                            </li>
                            <li class="nav-item">
