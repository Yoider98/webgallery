...
if (!isset($_SESSION['Rol'])=='artista') {
    header("Location: ../../ROLES/ARTISTA/artista.php");
}
        ...
        <header style="background-color: #ece8b0;" class="container">
            <div class="menus">
                <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <ul class="navbar-nav ">
                                <li class="nav-item active">
                                    <a class="nav-link boton"
                                        href="index.php">&nbsp&nbsp&nbsp&nbspInicio&nbsp&nbsp&nbsp&nbsp&nbsp</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div>
                        <a href="carrito.php"><img style="width: 120%; margin-left: -909%; margin-top: 90%;"
                                src="img/carrito.ico"></a>
                    </div>
                    <div>
                        <a href="login.php"><img style="width: 120%; margin-left: -840%; margin-top: 90%;"
